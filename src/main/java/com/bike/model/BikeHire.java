...
public class BikeHire {
  ...
  @Transient private final RoundingMode ROUNDING_MODE = RoundingMode.CEILING;
  ...
  @JoinColumn(
      name = "bike_id",
      nullable = false,
      foreignKey = @ForeignKey(name = "bike_hire_bike_id"))
  private Bike bike;
  ...
  @JoinColumn(
      name = "borrower_id",
      nullable = false,
      foreignKey = @ForeignKey(name = "bike_hire_borrower_id"))
